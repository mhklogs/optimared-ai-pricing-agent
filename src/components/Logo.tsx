 ...
 * single accent color #FFC53D. No icon library, no emoji.
 */
  ...
  return (
    ...
    >
      <circle
        ...
        strokeLinecap="round"
      />
      <path d="M32 4v5" stroke="#FFC53D" strokeWidth="2.4" strokeLinecap="round" />
      <circle cx="32" cy="4" r="1.7" fill="#FFC53D" />
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M44 19l-4.5-1.2M44 19l-1.2-4.5" stroke="#FFC53D" strokeWidth="2.6" strokeLinecap="round" />
      <circle cx="44" cy="19" r="2.1" fill="#FFC53D" />
    </svg>
  );
}

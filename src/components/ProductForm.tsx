  ...
  return (
    <form id="sku-parameters-form" onSubmit={handleSubmit} className="space-y-4">
      <div className="flex items-center justify-between border-b border-stone-100 pb-3">
        ...
        <span className="text-xs bg-blue-50 text-blue-600 font-mono px-2 py-0.5 rounded border border-blue-100">
          {id}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-800 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-white border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-800 focus:outline-none focus:border-blue-500"
          >
      ...
      <div className="bg-stone-50 p-4 rounded-2xl border border-stone-100 space-y-3">
        <h4 className="text-xs font-mono font-semibold text-stone-500 tracking-wider uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-800 focus:outline-none focus:border-blue-500 font-mono focus:ring-1 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <div className="group relative">
                ...
                <div className="absolute hidden group-hover:block bg-stone-800 text-white text-xs p-2 rounded w-48 shadow-xl -top-12 left-1/2 transform -translate-x-1/2 border border-stone-700 z-50">
      ...
      <div className="bg-stone-50 p-4 rounded-2xl border border-stone-100 space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-white border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-800 focus:outline-none focus:border-blue-500 font-mono focus:ring-1 focus:ring-blue-500"
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                e.preventDefault();
                handleAddCompetitor();
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          {competitorPrices.length === 0 ? (
            ...
            competitorPrices.map((price, idx) => (
              <span
                key={idx}
                className="inline-flex items-center gap-1.5 bg-white border border-stone-200 px-2.5 py-1 rounded-full text-xs font-mono text-blue-600"
              >
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={onCancel}
          className="px-4 py-2 border border-stone-200 text-stone-600 hover:bg-stone-100 rounded-lg text-sm transition-colors cursor-pointer"
        >
          Cancel
        </button>
        <button
          type="submit"
          className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold transition-all shadow-sm cursor-pointer"
        >
